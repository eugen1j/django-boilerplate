...
from django_boilerplate.blog.serializers import BlogTagSerializer, BlogCategorySerializer, \
    BlogPostSerializer, BlogImageSerializer
...
from django_boilerplate.common.drf_helpers.views import ChoicesMixin, LabelsMixin, DictionaryMixin
    ...
    def perform_destroy(self, instance):
        try:
            ...
            raise BadRequestError(
                _("You cannot delete category with existing posts"))
